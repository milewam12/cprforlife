        ...
        return (
            <div>
                ...
                <div className="container" >
                    <div className="row">
                        <div className="col-md-12 text-center" id="thanks">
                            <h1>Thanks for registering!</h1>
                            <p className="lead">One of our staff members will get in touch with you shortly. Meanwhile learn more about why is so important to learn CPR</p>
                        </div>
